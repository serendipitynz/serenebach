...
func (v PageView) Render() (string, error) {
	...
	timeStr := html.EscapeString(v.Site.FormatEntryTime(v.Page.CreatedAt))
	c.Tag("entry_time", `<a href="`+permalink+`">`+timeStr+`</a>`)
	c.Tag("entry_disp_time", timeStr)
	c.Tag("entry_description", formatBody(v.Page.Body, v.Page.Format, "page.body"))
	c.Tag("entry_sequel", "")
	...
	c.Tag("entry_og_image", "")
	c.Tag("entry_og_image_width", "")
	c.Tag("entry_og_image_height", "")
